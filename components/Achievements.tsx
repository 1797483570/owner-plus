        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <ScrollReveal>
            <div>
              ...
              <div className="glass-card p-8 rounded-2xl relative overflow-hidden group hover:border-cyan-500/50 transition-colors">
            ...
            <div className="grid gap-4">
              {AWARDS.map((award, idx) => (
                <ScrollReveal key={award.id} delay={200 + idx * 50}>
                  <div className="glass-card p-4 rounded-lg flex items-center justify-between hover:translate-x-2 transition-transform cursor-default hover:bg-slate-800/80 border-l-4 border-l-transparent hover:border-l-yellow-400">
